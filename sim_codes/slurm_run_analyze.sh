...
save_dest=~/Active_fluctuations/data/SAC_exp_G100_N100_free
...
for F in 0.3 1.0 2.0; do
#for F in 0.0; do
mkdir $save_dest/T_$T/F_$F

for Ta in 0.1 1.0 10.0 100.0; do
...
python3 run_analyze.py -s $save_dest/analysis/ -VCV -gyr -MSD -rep $replica
"
