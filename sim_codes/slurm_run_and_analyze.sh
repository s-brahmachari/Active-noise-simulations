...
save_dest=~/Active_fluctuations/data/ROUSE_chain_confined_N100
run_code_home=~/Active_fluctuations/sim_codes
...
for F in 0.0 0.1 1.0; do
#mkdir $save_dest/T_$T/F_$F

for Ta in 1.0 10.0 50.0; do
...
#cp $run_code_home/$seq $sim_home
#cp $run_code_home/$top $sim_home
#cp $run_code_home/Custom_Bonds.py $sim_home 
#cp $run_code_home/Custom_integrators.py $sim_home
